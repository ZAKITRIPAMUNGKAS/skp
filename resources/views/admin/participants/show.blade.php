        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center">
                <div class="w-28 h-28 rounded-full bg-primary/10 mx-auto mb-4 flex items-center justify-center border-4 border-white shadow-md overflow-hidden relative group">
                    @if($peserta->foto)
                        <img src="{{ $peserta->foto_url }}" class="w-full h-full object-cover">
                    ...
                    @else
                        <span class="text-3xl font-bold text-primary">{{ strtoupper(substr($peserta->nama_lengkap, 0, 2)) }}</span>
                    @endif
                </div>
          ...
          <div class="flex min-h-full items-center justify-center p-4">
              <div x-show="showModal"
                   ...
                   <div class="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex items-center justify-end">
                       <button type="button" @click="showModal = false" class="px-4 py-2 bg-gray-200 text-gray-700 text-xs font-bold rounded-lg hover:bg-gray-300 transition-colors">
                           Tutup
                       </button>
                   </div>
              </div>
