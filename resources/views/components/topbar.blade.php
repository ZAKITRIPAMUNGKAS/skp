    ...
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <nav class="hidden sm:flex items-center text-sm">
                <a href="{{ auth()->user()->isFasilitator() ? route('admin.events.index') : (auth()->user()->isAdmin() ? route('admin.dashboard') : route('peserta.dashboard')) }}"
        ...
        <div class="flex items-center gap-2">
            ...
            <div x-data="{ profileOpen: false }" class="relative" @click.stop>
                ...
                <div x-show="profileOpen" @click.outside="profileOpen = false"
                    ...
                    <div class="py-1">
                        <a href="{{ auth()->user()->role === 'peserta' ? route('peserta.profile.index') : route('admin.profile.index') }}" 
