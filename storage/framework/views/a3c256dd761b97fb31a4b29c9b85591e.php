    ...
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <nav class="hidden sm:flex items-center text-sm">
                <a href="<?php echo e(auth()->user()->isFasilitator() ? route('admin.events.index') : (auth()->user()->isAdmin() ? route('admin.dashboard') : route('peserta.dashboard'))); ?>"
            ...
            <div x-data="{ profileOpen: false }" class="relative" @click.stop>
                <button @click="profileOpen = !profileOpen"
                    ...
                    <div class="hidden sm:block text-left">
                        ...
                        <p class="text-xs text-gray-400 capitalize leading-tight"><?php echo e(auth()->user()->role); ?></p>
                    </div>
                ...
                <div x-show="profileOpen" @click.outside="profileOpen = false"
                    ...
                    <div class="py-1">
                        <a href="<?php echo e(auth()->user()->role === 'peserta' ? route('peserta.profile.index') : route('admin.profile.index')); ?>" 
...
<?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/components/topbar.blade.php ENDPATH**/ ?>