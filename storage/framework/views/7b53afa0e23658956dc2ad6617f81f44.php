<?php $__env->startSection('title', 'Bank Soal — ARQAM'); ?>
...
<div class="p-6" x-data="{ 
    ...
    eventsData: <?php echo e($events->map(fn($e) => ['id' => $e->id, 'nama_event' => $e->nama_event, 'lokasi' => $e->lokasi, 'sessions' => $e->eventSesi->map(fn($s) => ['id' => $s->id, 'nama_sesi' => $s->nama_sesi])])->toJson()); ?>,
    ...
    toggleAll(e) {
        const currentPageIds = <?php echo json_encode($soals->pluck('id')->toArray(), 15, 512) ?>;
        if (e.target.checked) {
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1"><?php echo e(auth()->user()->isAdmin() ? 'Kelola seluruh database soal pretest dan posttest.' : 'Kelola soal pretest dan posttest pada event Anda.'); ?></p>
        </div>
        
        <form method="GET" action="<?php echo e(route('admin.soal.index')); ?>" class="flex gap-2">
            <div class="relative">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $soals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50/50 transition-colors group">
                        <td class="px-6 py-4 text-center">
                            <input type="checkbox" :value="<?php echo e($s->id); ?>" x-model="selectedSoalIds" class="rounded border-gray-300 text-primary focus:ring-primary cursor-pointer">
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-gray-800 line-clamp-2 max-w-md"><?php echo e($s->teks_soal); ?></p>
                            <div class="flex gap-1 mt-1">
                                <?php $__currentLoopData = $s->pilihanJawaban; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="text-[9px] px-1 rounded <?php echo e($p->is_correct ? 'bg-green-100 text-green-600 font-bold' : 'bg-gray-100 text-gray-400'); ?>">
                                        <?php echo e($p->huruf); ?>
                        ...
                        <td class="px-6 py-4 text-gray-600">
                            <span class="text-xs font-medium"><?php echo e($s->event->nama_event ?? 'Event Tidak Ditemukan'); ?></span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ddbc40e602c342e508ac696e52f8719 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['type' => $s->tipe === 'pretest' ? 'persiapan' : 'berlangsung']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($s->tipe === 'pretest' ? 'persiapan' : 'berlangsung')]); ?>
                                <?php echo e(strtoupper($s->tipe)); ?>
...
<?php endif; ?>
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-3">
                                <button type="button" 
                                        @click="targetSoalUrl = '<?php echo e(route('admin.soal.copyToEvent', $s)); ?>'; targetSoalTeks = '<?php echo e(addslashes($s->teks_soal)); ?>'; tipe = '<?php echo e($s->tipe); ?>'; selectedEventId = ''; showCopyModal = true"
                                ...
                                <?php if($s->event_id): ?>
                                    <a href="<?php echo e(route('admin.events.show', $s->event_id)); ?>" class="text-xs text-slate-500 hover:text-primary hover:underline">Edit</a>
                                <?php endif; ?>
                            </div>
                        </td>
                    </tr>
        ...
        <?php if($soals->hasPages()): ?>
        <div class="px-6 py-4 border-t border-gray-50 bg-gray-50/30">
            <?php echo e($soals->links()); ?>
    ...
    <div x-show="showBulkCopyModal" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm px-4"
        ...
        <div x-show="showBulkCopyModal" x-transition class="bg-white rounded-2xl shadow-xl border border-gray-100 w-full max-w-md">
            ...
            <form action="<?php echo e(route('admin.soal.copyBulk')); ?>" method="POST" class="p-6" @submit="localStorage.removeItem('selected_soal_ids')">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/admin/soal/index.blade.php ENDPATH**/ ?>