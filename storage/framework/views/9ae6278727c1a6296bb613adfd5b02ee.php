...
<head>
    <meta charset="UTF-8">
    <title>ID Card – <?php echo e($peserta->nama_lengkap); ?></title>
    <style>
        @page {
            margin: 0;
            size: 86mm 137mm;
...
<div class="card-front page-break">
    ...
    <div class="card-content">
        ...
        <div class="photo-area">
            <?php if($peserta->foto && $peserta->foto_base64): ?>
                <div class="photo-square">
                    <img src="<?php echo e($peserta->foto_base64); ?>" alt="Foto">
                </div>
            <?php else: ?>
        ...
        <?php if($peserta->nama_panggilan): ?>
            <div class="nickname-area">
                <span class="nickname-badge"><?php echo e($peserta->nama_panggilan); ?></span>
            </div>
        <?php endif; ?>

        
        <div class="full-name"><?php echo e($peserta->nama_lengkap); ?></div>

        
        <div class="unit-text"><?php echo e($peserta->unit_kerja ?? 'Peserta Baitul Arqam'); ?></div>
        ...
        <div class="qr-area">
            ...
            ?>
            <div class="qr-box">
                <img src="data:image/svg+xml;base64,<?php echo e(base64_encode($qrCode)); ?>" alt="QR Code">
            </div>
        </div>
...
<?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/peserta/idcard-pdf.blade.php ENDPATH**/ ?>