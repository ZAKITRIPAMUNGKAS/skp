...
<div class="space-y-6" x-data="{ activeTab: 'edit' }">
    ...
    <div class="bg-gradient-to-r from-primary to-primary-700 rounded-3xl p-6 text-white flex items-center gap-5">
        ...
        <div>
            <h2 class="text-xl font-bold leading-tight"><?php echo e($peserta->nama_lengkap); ?></h2>
            <p class="text-primary-100 text-sm mt-0.5"><?php echo e($peserta->unit_kerja ?? 'Peserta Baitul Arqam'); ?></p>
            <p class="text-primary-200 text-xs mt-1">&#64;<?php echo e(auth()->user()->username); ?></p>
        </div>
    </div>
    ...
    <div x-show="activeTab === 'edit'" x-transition>
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <form action="<?php echo e(route('peserta.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>

                <div class="flex flex-col sm:flex-row gap-6 items-start">
                    <div class="shrink-0 flex flex-col items-center" id="profilePhotoSection"
                         x-data="{ preview: '<?php echo e($peserta->foto_url); ?>' }">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex-1 space-y-4 w-full">
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $peserta->nama_lengkap)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="no_hp" value="<?php echo e(old('no_hp', $peserta->no_hp)); ?>"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Unit Kerja / Instansi</label>
                                <input type="text" name="unit_kerja" value="<?php echo e(old('unit_kerja', $peserta->unit_kerja)); ?>"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_panggilan" value="<?php echo e(old('nama_panggilan', $peserta->nama_panggilan)); ?>"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                            <div>
                                ...
                                <select name="jenis_kelamin" class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                                    ...
                                    <option value="L" <?php echo e(old('jenis_kelamin', $peserta->jenis_kelamin) == 'L' ? 'selected' : ''); ?>>Laki-laki</option>
                                    <option value="P" <?php echo e(old('jenis_kelamin', $peserta->jenis_kelamin) == 'P' ? 'selected' : ''); ?>>Perempuan</option>
                                </select>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nik" value="<?php echo e(old('nik', $peserta->nik)); ?>" maxlength="16"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">NBM (Nomor Baku Muhammadiyah)</label>
                                <input type="text" name="nbm" value="<?php echo e(old('nbm', $peserta->nbm)); ?>"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir', $peserta->tempat_lahir)); ?>"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Lahir</label>
                                <input type="date" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir', $peserta->tanggal_lahir ? $peserta->tanggal_lahir->format('Y-m-d') : '')); ?>"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="jabatan_aum" value="<?php echo e(old('jabatan_aum', $peserta->jabatan_aum)); ?>"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                            </div>
                            <div>
                                ...
                                <select name="ukuran_kaos" class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                                    ...
                                    <?php $__currentLoopData = ['S', 'M', 'L', 'XL', 'XXL', 'XXXL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($size); ?>" <?php echo e(old('ukuran_kaos', $peserta->ukuran_kaos) == $size ? 'selected' : ''); ?>><?php echo e($size); ?></option>
                            ...
                            <div>
                                ...
                                <select name="status_pernikahan" class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                                    ...
                                    <?php $__currentLoopData = ['Belum Kawin', 'Kawin', 'Cerai Hidup', 'Cerai Mati']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($status); ?>" <?php echo e(old('status_pernikahan', $peserta->status_pernikahan) == $status ? 'selected' : ''); ?>><?php echo e($status); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="email" value="<?php echo e($peserta->email); ?>" disabled
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-2 p-3 bg-gray-50 border border-gray-200 rounded-xl">
                                    <?php $__currentLoopData = ['Inggris', 'Arab', 'Mandarin', 'Jepang']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="flex items-center gap-2 text-sm text-gray-700 cursor-pointer select-none">
                                            <input type="checkbox" name="bahasa_dikuasai[]" value="<?php echo e($lang); ?>"
                                                <?php if(in_array($lang, $currentBahasas)): ?> checked <?php endif; ?>
                                ...
                                <?php $__errorArgs = ['bahasa_dikuasai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                            ...
                            <div>
                                ...
                                <select name="hafalan_quran_1" required class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50">
                                    ...
                                    <?php $__currentLoopData = [
                                        ...
                                        '11-20 Juz',
                                        '21-30 Juz (Hafidz)'
                                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hafalan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($hafalan); ?>" <?php echo e(old('hafalan_quran_1', $peserta->hafalan_quran_1) == $hafalan ? 'selected' : ''); ?>><?php echo e($hafalan); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['hafalan_quran_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-xs text-red-500 mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="alamat_rumah" rows="3"
                                class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-gray-50/50 resize-none"><?php echo e(old('alamat_rumah', $peserta->alamat_rumah)); ?></textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    <?php echo biodataField('Nama Lengkap', $peserta->nama_lengkap); ?>

                    <?php echo biodataField('NIK', $peserta->nik); ?>

                    <?php echo biodataField('NBM (Nomor Baku Muhammadiyah)', $peserta->nbm); ?>

                    <?php echo biodataField('Jenis Kelamin', $peserta->jenis_kelamin === 'L' ? 'Laki-laki' : ($peserta->jenis_kelamin === 'P' ? 'Perempuan' : null)); ?>

                    <?php echo biodataField('Tempat Lahir', $peserta->tempat_lahir); ?>

                    <?php echo biodataField('Tanggal Lahir', $peserta->tanggal_lahir ? \Carbon\Carbon::parse($peserta->tanggal_lahir)->translatedFormat('d F Y') : null); ?>

                    <?php echo biodataField('Umur', $peserta->umur ? $peserta->umur.' Tahun' : null); ?>

                    <?php echo biodataField('Status Pernikahan', $peserta->status_pernikahan); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    <?php echo biodataField('Nomor HP / WA', $peserta->no_hp); ?>

                    <?php echo biodataField('Email', $peserta->email); ?>

                    <?php echo biodataField('Jabatan di AUM', $peserta->jabatan_aum); ?>

                    <?php echo biodataField('Unit Kerja / Instansi', $peserta->unit_kerja); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    <?php echo biodataField('Kabupaten / Kota', $peserta->kabupaten); ?>

                    <?php echo biodataField('Kecamatan', $peserta->kecamatan); ?>

                    <?php echo biodataField('Desa / Kelurahan', $peserta->desa_kelurahan); ?>

                    <?php echo biodataField('Alamat Lengkap', $peserta->alamat_rumah); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    <?php echo biodataField('Pendidikan Terakhir', $peserta->pendidikan_terakhir); ?>

                    <?php echo biodataField('Bahasa Dikuasai', $peserta->bahasa_dikuasai); ?>

                    <?php echo biodataField('SD', $peserta->pendidikan_sd); ?>

                    <?php echo biodataField('SMP / MTs', $peserta->pendidikan_smp); ?>

                    <?php echo biodataField('SMA / SMK / MA', $peserta->pendidikan_sma); ?>

                    <?php echo biodataField('S1 (Kampus & Prodi)', $peserta->pendidikan_s1); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    <?php echo biodataField("Kemampuan Baca Al-Qur'an", $peserta->kemampuan_baca_quran); ?>

                    <?php echo biodataField("Hafalan Al-Qur'an", $peserta->hafalan_quran_1); ?>

                    <?php echo biodataField('Sholat Berjamaah di Masjid', $peserta->aktivitas_sholat_masjid); ?>

                    <?php echo biodataField('Kehadiran Kajian Agama', $peserta->aktivitas_kajian_agama); ?>

                    <?php echo biodataField('Jumlah Buku Agama', $peserta->jumlah_buku_agama ? $peserta->jumlah_buku_agama.' buku' : null); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    <?php echo biodataField('Sumber Info Muhammadiyah', $peserta->sumber_info_muhammadiyah); ?>

                    <?php echo biodataField('Suara Muhammadiyah', $peserta->langganan_suara_muhammadiyah); ?>

                    <?php echo biodataField('Lembaga ZIS Diikuti', $peserta->lembaga_zis_diikuti); ?>

                    <?php echo biodataField('Keaktifan Muhammadiyah', $peserta->keaktifan_muhammadiyah); ?>

                    <?php echo biodataField('Keaktifan Ortom', $peserta->keaktifan_ortom); ?>

                    <?php echo biodataField('Organisasi Lain', $peserta->organisasi_lain); ?>

                    <?php echo biodataField('Tokoh Berpengaruh', $peserta->tokoh_berpengaruh); ?>

                    <?php echo biodataField('Alasan Memilih Tokoh', $peserta->alasan_pilih_tokoh); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-y-4">
                    <?php echo biodataField('Harapan terhadap PCM', $peserta->harapan_pcm); ?>

                    <?php echo biodataField('Harapan Mengikuti Baitul Arqam', $peserta->harapan_mengikuti_ba); ?>
    ...
    <div x-show="activeTab === 'riwayat'" x-transition>
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div class="space-y-4">
                ...
                <div class="relative pl-7 border-l-2 <?php if($loop->first): ?> border-primary <?php else: ?> border-gray-200 <?php endif; ?> pt-1 pb-5">
                    <span class="absolute -left-[9px] top-1 w-4 h-4 rounded-full border-4 border-white <?php if($loop->first): ?> bg-primary <?php else: ?> bg-gray-300 <?php endif; ?>"></span>
                    <h4 class="text-sm font-semibold text-gray-800 leading-tight mb-1"><?php echo e($h->event->nama_event); ?></h4>
                    <p class="text-[10px] text-gray-500 font-medium mb-2 uppercase tracking-wide">
                        <?php echo e(\Carbon\Carbon::parse($h->event->tanggal_mulai)->translatedFormat('d M Y')); ?>
                    ...
                    <div class="bg-gray-50 rounded-xl p-3 border border-gray-100 text-xs space-y-1.5">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold capitalize <?php if($h->event->status=='selesai'): ?> text-blue-600 <?php else: ?> text-green-600 <?php endif; ?>"><?php echo e(ucfirst($h->event->status)); ?></span>
                        </div>
                        <?php $nilai = \App\Models\PenilaianAkhir::where('event_id', $h->event_id)->where('peserta_id', $peserta->id)->first(); ?>
                        <?php if($h->event->status == 'selesai' && $nilai): ?>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-500">Nilai Akhir</span>
                            <span class="font-bold text-primary"><?php echo e(number_format($nilai->nilai_akhir, 2)); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-500">Peringkat</span>
                            <span class="font-semibold text-gray-700">#<?php echo e($nilai->ranking); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-500">Status Kelulusan</span>
                            <span class="font-semibold <?php echo e(str_contains($nilai->status_kelulusan ?? '', 'Tidak') ? 'text-red-500' : 'text-emerald-600'); ?>">
                                <?php echo e($nilai->status_kelulusan ?? '-'); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/peserta/profile/index.blade.php ENDPATH**/ ?>