...
<div x-data="{ evalMenuOpen: false }">
    <div class="fixed bottom-0 left-0 z-40 w-full h-16 bg-white border-t border-gray-200 lg:hidden flex justify-around items-stretch pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        ...
        <a href="<?php echo e(route('peserta.dashboard')); ?>"
           class="inline-flex flex-col items-center justify-center flex-1 hover:bg-gray-50 group transition-colors <?php echo e($currentRoute == 'peserta.dashboard' ? 'text-primary' : 'text-gray-500'); ?>">
            <svg class="w-5 h-5 mb-0.5 <?php echo e($currentRoute == 'peserta.dashboard' ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?>"
        ...
        <a href="<?php echo e(route('peserta.jadwal')); ?>"
           class="inline-flex flex-col items-center justify-center flex-1 hover:bg-gray-50 group transition-colors <?php echo e($currentRoute == 'peserta.jadwal' ? 'text-primary' : 'text-gray-500'); ?>">
            <svg class="w-5 h-5 mb-0.5 <?php echo e($currentRoute == 'peserta.jadwal' ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?>"
                 fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <?php if($event): ?>
            <a href="<?php echo e(route('peserta.tes.index')); ?>"
               class="inline-flex flex-col items-center justify-center flex-1 hover:bg-gray-50 group transition-colors <?php echo e(Str::contains($currentRoute, 'peserta.tes') ? 'text-primary' : 'text-gray-500'); ?>">
                <svg class="w-5 h-5 mb-0.5 <?php echo e(Str::contains($currentRoute, 'peserta.tes') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?>"
                     fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <button @click="evalMenuOpen = true"
                class="inline-flex flex-col items-center justify-center flex-1 hover:bg-gray-50 group transition-colors <?php echo e((Str::contains($currentRoute, 'peserta.afektif') || Str::contains($currentRoute, 'peserta.angket')) ? 'text-primary' : 'text-gray-500'); ?>">
            <svg class="w-5 h-5 mb-0.5 <?php echo e((Str::contains($currentRoute, 'peserta.afektif') || Str::contains($currentRoute, 'peserta.angket')) ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?>"
                 fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?php echo e(route('peserta.profile.index')); ?>"
           class="inline-flex flex-col items-center justify-center flex-1 hover:bg-gray-50 group transition-colors <?php echo e($currentRoute == 'peserta.profile.index' ? 'text-primary' : 'text-gray-500'); ?>">
            <svg class="w-5 h-5 mb-0.5 <?php echo e($currentRoute == 'peserta.profile.index' ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?>"
                 fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div x-show="evalMenuOpen"
        ...
        <div class="space-y-4 flex-1">
            ...
            <a href="<?php echo e(route('peserta.afektif.index_root')); ?>"
            ...
            <a href="<?php echo e(route('peserta.angket.index_root')); ?>"
               class="flex items-center gap-4 p-4 bg-gray-50 hover:bg-primary/5 rounded-2xl border border-gray-100 group transition-all">
...
<?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/components/bottom-nav.blade.php ENDPATH**/ ?>