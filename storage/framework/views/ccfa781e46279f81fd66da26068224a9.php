...
<div class="space-y-8 pb-12">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex items-center gap-5">
                <div class="w-20 h-20 bg-white/10 rounded-2xl flex items-center justify-center p-1 border border-white/20 backdrop-blur-sm shrink-0">
                    <img src="<?php echo e(asset('images/arka/arka_alert.png')); ?>" alt="Alert" class="w-full h-full object-contain drop-shadow-lg">
                </div>
                <div class="text-center md:text-left">
                    ...
                    <p class="text-orange-50/90 text-sm leading-relaxed">
                        Data diri Anda belum lengkap (Yang masih kosong: <strong class="text-white underline"><?php echo e(implode(', ', $missingFields)); ?></strong>). Mohon lengkapi data Anda untuk mempermudah proses evaluasi dan penerbitan sertifikat.
                    </p>
                </div>
            </div>
            <a href="<?php echo e(route('peserta.profile.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-white text-orange-600 rounded-2xl font-bold text-sm hover:bg-orange-50 transition-all shadow-md active:scale-95 shrink-0">
    ...
    <?php if($activeEvent): ?>
    <?php if($activeEvent->status === 'persiapan'): ?>
        <div class="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl p-8 md:p-12 text-center max-w-2xl mx-auto space-y-6 animate-fade-in my-8">
            <div class="w-32 h-32 mx-auto bg-amber-50 rounded-full flex items-center justify-center border border-amber-100">
                <img src="<?php echo e(asset('images/arka/arka_penilai.png')); ?>" alt="Mascot Waiting" class="w-24 h-24 object-contain">
            </div>
            <div class="space-y-2">
            ...
            <p class="text-gray-500 text-sm leading-relaxed max-w-md mx-auto">
                Kegiatan <strong><?php echo e($activeEvent->nama_event); ?></strong> saat ini masih dalam tahap persiapan. Seluruh fitur evaluasi, tes mandiri, jadwal, dan presensi kehadiran akan diaktifkan secara otomatis setelah event dimulai oleh panitia.
            </p>
            <div class="pt-4">
                <a href="<?php echo e(route('peserta.profile.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-2xl font-bold text-sm hover:bg-primary/95 transition-all shadow-md active:scale-95">
    ...
    <?php else: ?>
            ...
            <div class="relative px-8 py-10 md:px-12 md:py-14 flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="flex-1 text-center md:text-left space-y-4">
                    ...
                    <h1 class="text-4xl md:text-5xl font-heading font-extrabold text-white leading-[1.1]">
                        Assalamu'alaikum,<br>
                        <span class="text-accent-200"><?php echo e($peserta->nama_lengkap); ?></span>
                    </h1>
                    ...
                    <div class="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
                        <div class="px-5 py-3 bg-white/10 rounded-2xl border border-white/20 backdrop-blur-sm">
                            ...
                            <span class="text-xl font-bold text-white"><?php echo e($progress['attended'] ?? 0); ?> / <?php echo e($progress['total_sesi'] ?? 0); ?></span>
                        </div>
                        <div class="px-5 py-3 bg-white/10 rounded-2xl border border-white/20 backdrop-blur-sm">
                            <span class="block text-[10px] text-primary-200 uppercase font-bold tracking-wider mb-0.5">Status Akhir</span>
                            <span class="text-xl font-bold text-white">
                                <?php if($activeEvent->status == 'selesai'): ?>
                                    <?php echo e($scores->predikat ?? 'Menunggu'); ?>
                ...
                <div class="w-64 h-64 md:w-80 md:h-80 flex-shrink-0 animate-float-slow">
                    <img src="<?php echo e(asset('images/arka/arka_greeting.png')); ?>" alt="Arka Greeting" class="w-full h-full object-contain drop-shadow-2xl">
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-4 space-y-8">
                ...
                <div class="relative bg-white rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 ticket-cut">
                    ...
                    <div class="bg-primary p-6 text-white text-center">
                        <div class="w-16 h-16 bg-white rounded-2xl mx-auto mb-4 p-2 shadow-lg">
                            <img src="<?php echo e(url('/logo.webp')); ?>" class="w-full h-full object-contain" alt="Logo">
                        </div>
                        <h3 class="font-heading font-bold text-lg mb-1"><?php echo e($activeEvent->nama_event); ?></h3>
                        <p class="text-primary-100 text-xs font-medium uppercase tracking-widest"><?php echo e($peserta->unit_kerja); ?></p>
                    </div>
                    ...
                    <div class="p-8 flex flex-col items-center">
                        ...
                        <div class="w-24 h-24 rounded-full border-4 border-slate-50 overflow-hidden mb-6 shadow-md flex-shrink-0 bg-primary/10 flex items-center justify-center">
                            <?php if($peserta->foto): ?>
                                <img src="<?php echo e($peserta->foto_url); ?>" referrerpolicy="no-referrer" class="w-full h-full object-cover" alt="Foto">
                            <?php else: ?>
                        ...
                        <div class="relative">
                            ...
                            <?php if($eventPeserta && $eventPeserta->qr_code): ?>
                                <?php
                        ...
                        <div class="mt-8 text-center space-y-4 w-full">
                            <div>
                                ...
                                <p class="text-lg font-mono font-bold text-gray-800"><?php echo e('ARQ-'.str_pad($peserta->id, 4, '0', STR_PAD_LEFT)); ?></p>
                            </div>
                            
                            <hr class="border-dashed border-gray-200">
                            
                            <a href="<?php echo e(route('peserta.idcard.download', $activeEvent)); ?>" 
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <p class="text-xl font-extrabold text-gray-800"><?php echo e(round((($progress['attended'] ?? 0) / max(($progress['total_sesi'] ?? 1), 1)) * 100)); ?>%</p>
                </div>
                <div class="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <p class="text-xl font-extrabold text-gray-800"><?php echo e($progress['attended'] ?? 0); ?> / <?php echo e($progress['total_sesi'] ?? 0); ?></p>
                </div>
            </div>
        ...
        <div class="lg:col-span-8 space-y-8">
                ...
                <div class="px-8 py-8 border-b border-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="h-2 w-32 bg-gray-100 rounded-full overflow-hidden">
                            ...
                            ?>
                            <div class="h-full bg-primary transition-all duration-1000" style="width: <?php echo e($taskPercent); ?>%"></div>
                        </div>
                        <span class="text-xs font-bold text-primary"><?php echo e(round($taskPercent)); ?>%</span>
                    </div>
                </div>
                ...
                <div class="p-8">
                    <div class="relative space-y-8">
                        ...
                        <div class="relative flex items-start gap-6 group">
                            <div class="relative z-10 w-12 h-12 flex-shrink-0 rounded-2xl flex items-center justify-center transition-all duration-300 <?php echo e(($progress['pretest'] ?? false) ? 'bg-green-500 text-white shadow-lg shadow-green-200' : 'bg-white border-2 border-gray-200 text-gray-400 group-hover:border-primary/30'); ?>">
                                <?php if($progress['pretest'] ?? false): ?>
                            ...
                            <div class="flex-1 pt-1">
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                                    <div>
                                        <h4 class="text-lg font-bold <?php echo e(($progress['pretest'] ?? false) ? 'text-gray-800' : 'text-gray-500'); ?>">Pretest</h4>
                                        <p class="text-sm text-gray-400">Evaluasi pemahaman awal sebelum materi dimulai.</p>
                                        <?php if(($progress['pretest_total'] ?? 0) > 0): ?>
                                            <p class="text-xs text-primary font-bold mt-1">Progres: <?php echo e($progress['pretest_done']); ?> / <?php echo e($progress['pretest_total']); ?> Materi</p>
                                        <?php endif; ?>
                                        <?php if($sesiStatus['pretest'] && !($progress['pretest'] ?? false)): ?>
                                            <div x-data="{
                                                remaining: '',
                                                init() {
                                                    const remainingSecs = <?php echo e($sesiStatus['pretest_remaining_seconds']); ?>;
                                                    if (remainingSecs > 0) {
                                                ...
                                                <p class="text-xs text-accent font-bold mt-1 flex items-center gap-1">
                                                    ...
                                                    <span>Durasi: <span :class="remaining ? 'text-red-500 animate-pulse font-mono' : ''" x-text="remaining ? remaining : '<?php echo e($sesiStatus['pretest_durasi']); ?> Menit'"></span></span>
                                                </p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php else: ?>
                                        <?php if($sesiStatus['pretest'] && $sesiStatus['pretest_event_sesi_id']): ?>
                                            <a href="<?php echo e(route('peserta.tes.instruction', [$activeEvent, $sesiStatus['pretest_event_sesi_id'], 'pretest'])); ?>" class="inline-flex items-center gap-2 px-5 py-2 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary-600 transition-all shadow-md active:scale-95">
                                                Kerjakan Sekarang
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                                            </a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('peserta.tes.index')); ?>" class="px-4 py-1.5 bg-gray-100 text-gray-500 hover:text-primary rounded-lg text-xs font-bold uppercase tracking-widest border border-gray-200">Lihat Daftar Tes</a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="relative flex items-start gap-6 group">
                            <div class="relative z-10 w-12 h-12 flex-shrink-0 rounded-2xl flex items-center justify-center transition-all duration-300 <?php echo e(($progress['afektif'] ?? false) ? 'bg-green-500 text-white shadow-lg shadow-green-200' : 'bg-white border-2 border-gray-200 text-gray-400 group-hover:border-primary/30'); ?>">
                                <?php if($progress['afektif'] ?? false): ?>
                                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
                                <?php else: ?>
                            ...
                            <div class="flex-1 pt-1">
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                                    <div>
                                        <h4 class="text-lg font-bold <?php echo e(($progress['afektif'] ?? false) ? 'text-gray-800' : 'text-gray-500'); ?>">Penilaian Afektif</h4>
                                    ...
                                    <?php else: ?>
                                        <?php if($activeEvent->status == 'berlangsung'): ?>
                                            <a href="<?php echo e(route('peserta.afektif.index', $activeEvent)); ?>" class="inline-flex items-center gap-2 px-5 py-2 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary-600 transition-all shadow-md active:scale-95">
                                                Isi Kuesioner
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                                            </a>
                                        <?php else: ?>
                        ...
                        <div class="relative flex items-start gap-6 group">
                            <div class="relative z-10 w-12 h-12 flex-shrink-0 rounded-2xl flex items-center justify-center transition-all duration-300 <?php echo e(($progress['posttest'] ?? false) ? 'bg-green-500 text-white shadow-lg shadow-green-200' : 'bg-white border-2 border-gray-200 text-gray-400 group-hover:border-primary/30'); ?>">
                                <?php if($progress['posttest'] ?? false): ?>
                                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
                                <?php else: ?>
                            ...
                            <div class="flex-1 pt-1">
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                                    <div>
                                        <h4 class="text-lg font-bold <?php echo e(($progress['posttest'] ?? false) ? 'text-gray-800' : 'text-gray-500'); ?>">Posttest</h4>
                                        <p class="text-sm text-gray-400">Evaluasi pemahaman akhir setelah seluruh materi selesai.</p>
                                        <?php if(($progress['posttest_total'] ?? 0) > 0): ?>
                                            <p class="text-xs text-primary font-bold mt-1">Progres: <?php echo e($progress['posttest_done']); ?> / <?php echo e($progress['posttest_total']); ?> Materi</p>
                                        <?php endif; ?>
                                        <?php if($sesiStatus['posttest'] && !($progress['posttest'] ?? false)): ?>
                                            <div x-data="{
                                                remaining: '',
                                                init() {
                                                    const remainingSecs = <?php echo e($sesiStatus['posttest_remaining_seconds']); ?>;
                                                    if (remainingSecs > 0) {
                                                        const target = Date.now() + (remainingSecs * 1000);
                                                        const update = () => {
                                                            const diff = Math.max(0, Math.round((target - Date.now()) / 1000));
                                                ...
                                                <p class="text-xs text-accent font-bold mt-1 flex items-center gap-1">
                                                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                                    <span>Durasi: <span :class="remaining ? 'text-red-500 animate-pulse font-mono' : ''" x-text="remaining ? remaining : '<?php echo e($sesiStatus['posttest_durasi']); ?> Menit'"></span></span>
                                                </p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php else: ?>
                                        <?php if($sesiStatus['posttest'] && $sesiStatus['posttest_event_sesi_id']): ?>
                                            <a href="<?php echo e(route('peserta.tes.instruction', [$activeEvent, $sesiStatus['posttest_event_sesi_id'], 'posttest'])); ?>" class="inline-flex items-center gap-2 px-5 py-2 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary-600 transition-all shadow-md active:scale-95">
                                                Mulai Posttest
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                                            </a>
                                        <?php else: ?>
                        ...
                        <div class="relative flex items-start gap-6 group">
                            <div class="relative z-10 w-12 h-12 flex-shrink-0 rounded-2xl flex items-center justify-center transition-all duration-300 <?php echo e(($progress['angket'] ?? false) ? 'bg-green-500 text-white shadow-lg shadow-green-200' : 'bg-white border-2 border-gray-200 text-gray-400 group-hover:border-primary/30'); ?>">
                                <?php if($progress['angket'] ?? false): ?>
                                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
                                <?php else: ?>
                            ...
                            <div class="flex-1 pt-1">
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                                    <div>
                                        <h4 class="text-lg font-bold <?php echo e(($progress['angket'] ?? false) ? 'text-gray-800' : 'text-gray-500'); ?>">Angket Penyelenggaraan</h4>
                                    ...
                                    <?php else: ?>
                                        <?php if($activeEvent->status == 'selesai'): ?>
                                            <a href="<?php echo e(route('peserta.angket.fill', $activeEvent)); ?>" class="inline-flex items-center gap-2 px-5 py-2 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary-600 transition-all shadow-md active:scale-95">
                                                Isi Angket
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                                            </a>
                                        <?php else: ?>
                                ...
                                <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="group hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td class="py-4 text-right">
                                            <?php if($material->file_materi): ?>
                                                <a href="<?php echo e(asset('storage/' . $material->file_materi)); ?>" target="_blank"
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between text-xs border-b border-white/10 pb-2">
                                <span class="text-primary-300 font-medium"><?php echo e($label); ?></span>
                                <span class="font-bold text-accent"><?php echo e($chartData['data'][$index]); ?>%</span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <?php if($activeEvent->status == 'selesai' && $scores && $scores->ranking): ?>
                <div class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center gap-10">
                        <div class="flex-1 text-center md:text-left">
                            ...
                            <h3 class="text-4xl md:text-5xl font-heading font-extrabold mb-4 leading-tight">
                                ...
                                <span class="text-transparent bg-clip-text bg-gradient-to-r from-accent to-yellow-200">
                                    <?php echo e($scores->predikat); ?>

                                </span>
                            </h3>
                            <p class="text-gray-400 text-lg mb-8 max-w-md">
                                Selamat! Berdasarkan pengolahan data sistem, Anda menempati peringkat <strong class="text-white text-xl">#<?php echo e($scores->ranking); ?></strong> dari seluruh peserta.
                            </p>
                            
                            <?php if(!str_contains($scores->status_kelulusan, 'Tidak Lulus') && !empty($scores->status_kelulusan)): ?>
                                <div class="flex flex-wrap justify-center md:justify-start gap-4">
                                    <?php if($hasRtl): ?>
                                        <a href="<?php echo e(route('peserta.sertifikat.download', $activeEvent)); ?>" target="_blank"
                                    ...
                                    <?php else: ?>
                                        <div class="space-y-4">
                                            ...
                                            <a href="<?php echo e(route('peserta.rtl.index', $activeEvent)); ?>"
                        ...
                        <div class="flex-shrink-0 w-48 h-48 md:w-64 md:h-64 relative group">
                            ...
                            <img src="<?php echo e(asset('images/arka/arka_selebrasi.png')); ?>" alt="Celebration" class="relative z-10 w-full h-full object-contain animate-float-slow">
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/peserta/dashboard.blade.php ENDPATH**/ ?>