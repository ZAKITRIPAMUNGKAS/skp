            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative" data-aos="fade-right">
                    ...
                    <div class="relative z-10 bg-white rounded-[2rem] border border-slate-100 shadow-soft overflow-hidden aspect-[4/3] group">
                        <img src="<?php echo e(asset('kegiatan.webp')); ?>" alt="Baitul Arqam LP3A UMS" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
