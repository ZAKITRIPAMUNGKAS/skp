    ...
    <section id="fitur" class="py-24 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="text-accent font-bold tracking-wider uppercase text-sm mb-2 block"><?php echo e(\App\Models\SystemSetting::get('landing_advantages_subtitle', 'Keunggulan Sistem')); ?></span>
                <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-6"><?php echo e(\App\Models\SystemSetting::get('landing_advantages_title', 'Fitur Unggulan Sistem ARQAM')); ?></h2>
                <p class="text-gray-500 text-lg"><?php echo nl2br(e(\App\Models\SystemSetting::get('landing_advantages_description', 'Solusi praktis untuk mengelola pelatihan dengan akurasi penilaian yang didukung oleh sistem pendukung keputusan yang cerdas.'))); ?></p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php
                    ...
                    $delay = ($i % 3) * 100;
                ?>
                <!-- Feature <?php echo e($i + 1); ?> -->
                <div class="bg-surface rounded-3xl p-8 border border-gray-100 <?php echo e($c['border']); ?> hover:shadow-xl hover:bg-white transition-all duration-300 group" data-aos="fade-up" data-aos-delay="<?php echo e($delay); ?>">
                    <div class="w-14 h-14 <?php echo e($c['bg']); ?> rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 <?php echo e($c['hoverBg']); ?> transition-all duration-300 shadow-sm">
                        <?php echo $icon; ?>

                    </div>
                    <h3 class="text-xl font-heading font-bold text-gray-900 mb-3 group-hover:<?php echo e(str_replace('text-', 'text-', $c['text'])); ?> transition-colors"><?php echo e($adv['title']); ?></h3>
                    <p class="text-gray-500 leading-relaxed text-sm">
                        <?php echo e($adv['description']); ?>
