<?php $__env->startSection('title', 'Detail Peserta — ARQAM'); ?>

<?php $__env->startSection('content'); ?>
<div class="p-6 max-w-6xl mx-auto">
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('admin.participants.index')); ?>" class="p-2 bg-white border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
        ...
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('admin.participants.edit', $peserta)); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-primary text-white text-[13px] font-bold rounded-xl hover:bg-primary-dark transition-all shadow-sm">
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center">
                <div class="w-28 h-28 rounded-full bg-primary/10 mx-auto mb-4 flex items-center justify-center border-4 border-white shadow-md overflow-hidden relative group">
                    <?php if($peserta->foto): ?>
                        <img src="<?php echo e($peserta->foto_url); ?>" referrerpolicy="no-referrer" class="w-full h-full object-cover">
                        <a href="<?php echo e($peserta->foto); ?>" target="_blank" class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 flex items-center justify-center text-white text-xs transition-opacity font-semibold">
                            Buka Foto ↗
                        </a>
                    <?php else: ?>
                ...
                <h2 class="text-lg font-bold text-gray-800 leading-tight"><?php echo e($peserta->nama_lengkap); ?></h2>
                <p class="text-xs text-gray-400 font-mono mt-1 mb-4"><?php echo e('@' . ($peserta->user->username ?? '-')); ?></p>
                ...
                <div class="flex justify-center gap-2 flex-wrap">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-primary/10 text-primary border border-primary/20">
                        <?php echo e($peserta->unit_kerja ?? 'Peserta'); ?>

                    </span>
                    <?php if($peserta->arqam_ke): ?>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-accent/10 text-accent-600 border border-accent/30">
                            Arqam ke-<?php echo e($peserta->arqam_ke); ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-700 font-semibold"><?php echo e($peserta->nik ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">NBM (Nomor Baku Muhammadiyah)</p>
                        <p class="text-sm text-gray-700"><?php echo e($peserta->nbm ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Nama Panggilan</p>
                        <p class="text-sm text-gray-700"><?php echo e($peserta->nama_panggilan ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Jenis Kelamin</p>
                        <p class="text-sm text-gray-700"><?php echo e($peserta->jenis_kelamin ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Umur / Tgl Lahir</p>
                        <p class="text-sm text-gray-700">
                            <?php echo e($peserta->umur ? $peserta->umur . ' Tahun' : '-'); ?>

                            <?php if($peserta->tempat_lahir || $peserta->tanggal_lahir): ?>
                                <span class="text-xs text-gray-400 block">
                                    (<?php echo e($peserta->tempat_lahir ?? '-'); ?>, <?php echo e($peserta->tanggal_lahir ? $peserta->tanggal_lahir->format('d M Y') : '-'); ?>)
                                </span>
                            <?php endif; ?>
                        </p>
                    </div>
                    <div>
                        ...
                        <p class="text-sm text-gray-700">
                            <?php echo e($peserta->status_pernikahan ?? '-'); ?> 
                            <?php if($peserta->jumlah_anak !== null): ?>
                                (<?php echo e($peserta->jumlah_anak); ?> Anak)
                            <?php endif; ?>
                        </p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <a href="mailto:<?php echo e($peserta->email); ?>" class="text-sm text-primary hover:underline block break-all"><?php echo e($peserta->email ?? '-'); ?></a>
                    </div>
                    <div>
                        <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">No. WhatsApp</p>
                        <?php if($peserta->no_hp): ?>
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $peserta->no_hp)); ?>" target="_blank" class="text-sm text-primary hover:underline flex items-center gap-1">
                                <?php echo e($peserta->no_hp); ?> ↗
                            </a>
                        <?php else: ?>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-700 font-semibold"><?php echo e($peserta->unit_kerja ?? '-'); ?></p>
                        <?php if($peserta->jabatan_aum): ?>
                            <p class="text-xs text-gray-500 mt-0.5"><?php echo e($peserta->jabatan_aum); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" x-data="{ filterKesediaan: 'all' }">
                <div class="px-6 py-4 border-b border-gray-50 flex items-center justify-between">
                    <h3 class="text-sm font-bold text-gray-800">Riwayat Pendaftaran Event (<?php echo e($peserta->eventPeserta->count()); ?>)</h3>
                    <div class="flex items-center gap-2">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__empty_1 = true; $__currentLoopData = $peserta->eventPeserta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr x-show="filterKesediaan === 'all' || filterKesediaan === '<?php echo e($ep->konfirmasi_kesediaan ?? 'belum_konfirmasi'); ?>'" class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-6 py-4">
                                    <p class="font-medium text-gray-800"><?php echo e(optional($ep->event)->nama_event ?? 'Event tidak ditemukan/dihapus'); ?></p>
                                    <p class="text-[10px] text-gray-400"><?php echo e($ep->event ? \Carbon\Carbon::parse($ep->event->tanggal_mulai)->format('d M Y') : '-'); ?></p>
                                </td>
                                        ...
                                        <div class="inline-flex flex-col items-center">
                                            <button type="button" 
                                                @click="$dispatch('open-alasan-modal', { 
                                                    pesertaNama: '<?php echo e(addslashes($peserta->nama_lengkap)); ?>', 
                                            ...
                                            <?php if($ep->alasan_tidak_hadir): ?>
                                                <span class="text-[10px] text-gray-500 mt-1 max-w-[150px] truncate block" title="<?php echo e($ep->alasan_tidak_hadir); ?>">
                                                    "<?php echo e($ep->alasan_tidak_hadir); ?>"
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <?php if($ep->skor): ?>
                                        <span class="font-bold text-primary"><?php echo e(number_format($ep->skor->skor_akhir, 1)); ?></span>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <?php if($ep->skor): ?>
                                        <?php if(str_contains($ep->skor->status_kelulusan, 'Lulus')): ?>
                 ...
                 <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                     ...
                     <div class="space-y-3 text-sm">
                         <div>
                             ...
                             <p class="text-gray-700 leading-relaxed font-medium"><?php echo e($peserta->alamat_rumah ?? '-'); ?></p>
                         </div>
                         <div class="grid grid-cols-2 gap-4 pt-2">
                             <div>
                                 <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Desa/Kelurahan</p>
                                 <p class="text-gray-700 font-medium"><?php echo e($peserta->desa_kelurahan ?? '-'); ?></p>
                             </div>
                             <div>
                                 <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Kecamatan</p>
                                 <p class="text-gray-700 font-medium"><?php echo e($peserta->kecamatan ?? '-'); ?></p>
                             </div>
                             <div>
                                 <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Kabupaten/Kota</p>
                                 <p class="text-gray-700 font-medium"><?php echo e($peserta->kabupaten ?? '-'); ?></p>
                             </div>
                             <div>
                                 <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Provinsi</p>
                                 <p class="text-gray-700 font-medium"><?php echo e($peserta->provinsi ?? '-'); ?></p>
                             </div>
                         </div>
                     </div>
                 </div>
                     ...
                     <div class="space-y-4 text-sm">
                         <div>
                             ...
                             <?php if($peserta->arqam_ke): ?>
                                 <span class="inline-flex items-center px-3 py-1 bg-primary/10 text-primary border border-primary/20 rounded-lg text-xs font-bold mt-1">
                                     Ke-<?php echo e($peserta->arqam_ke); ?>
                         ...
                         <div>
                             ...
                             <span class="inline-flex items-center px-3 py-1 bg-yellow-50 text-yellow-700 border border-yellow-200 rounded-lg text-xs font-bold mt-1">
                                 <?php echo e($peserta->ukuran_kaos ?? '-'); ?>

                             </span>
                         </div>
                         <div>
                             <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Rencana Keberangkatan</p>
                             <p class="text-gray-700 font-medium leading-normal mt-0.5"><?php echo e($peserta->rencana_keberangkatan ?? '-'); ?></p>
                         </div>
                     </div>
                 </div>
             </div>
             ...
             <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm mb-6">
                     <div>
                         ...
                         <p class="text-gray-700 font-medium mt-1"><?php echo e($peserta->aktivitas_duduk ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Aktivitas Tangga</p>
                         <p class="text-gray-700 font-medium mt-1"><?php echo e($peserta->aktivitas_tangga ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Aktivitas Sholat</p>
                         <p class="text-gray-700 font-medium mt-1"><?php echo e($peserta->aktivitas_sholat ?? '-'); ?></p>
                     </div>
                 </div>
                 ...
                 <div class="space-y-4 text-sm">
                     <div>
                         ...
                         <p class="text-gray-700 mt-0.5 leading-relaxed"><?php echo e($peserta->catatan_makanan ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Catatan Kesehatan / Alergi / Penyakit</p>
                         <p class="text-gray-700 mt-0.5 leading-relaxed"><?php echo e($peserta->catatan_kesehatan ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Catatan Lain untuk Panitia</p>
                         <p class="text-gray-700 mt-0.5 leading-relaxed"><?php echo e($peserta->catatan_panitia ?? '-'); ?></p>
                     </div>
                 </div>
             </div>
             ...
             <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm mb-6">
                     <div>
                         ...
                         <p class="text-gray-700 font-semibold mt-1"><?php echo e($peserta->kemampuan_baca_quran ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Kompetensi Keberagamaan</p>
                         <p class="text-gray-700 font-semibold mt-1"><?php echo e($peserta->kompetensi_keberagamaan ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Kompetensi Akademis</p>
                         <p class="text-gray-700 font-semibold mt-1"><?php echo e($peserta->kompetensi_akademis ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Kompetensi Sosial</p>
                         <p class="text-gray-700 font-semibold mt-1"><?php echo e($peserta->kompetensi_sosial ?? '-'); ?></p>
                     </div>
                     <div class="md:col-span-2">
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Kompetensi Keorganisasian & Kepemimpinan</p>
                         <p class="text-gray-700 font-semibold mt-1"><?php echo e($peserta->kompetensi_keorganisasian ?? '-'); ?></p>
                     </div>
                 </div>
                 <hr class="border-gray-100 my-4" />
                 <div class="space-y-4 text-sm">
                     <div>
                         ...
                         <p class="text-gray-700 mt-1 leading-relaxed"><?php echo e($peserta->keaktifan_ortom ?? '-'); ?></p>
                     </div>
                     <div>
                         <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Keaktifan di Muhammadiyah/Aisyiyah</p>
                         <p class="text-gray-700 mt-1 leading-relaxed"><?php echo e($peserta->keaktifan_muhammadiyah ?? '-'); ?></p>
                     </div>
                 </div>
             </div>
             ...
             <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                     <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 flex flex-col justify-between gap-3">
                         ...
                         <?php if($peserta->surat_komitmen): ?>
                             <a href="<?php echo e($peserta->surat_komitmen); ?>" target="_blank" class="inline-flex items-center justify-center gap-2 px-3 py-2 bg-primary text-white text-[12px] font-bold rounded-lg hover:bg-primary-dark transition-all">
                     ...
                     <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 flex flex-col justify-between gap-3">
                         ...
                         <?php if($peserta->surat_tidak_bersedia): ?>
                             <a href="<?php echo e($peserta->surat_tidak_bersedia); ?>" target="_blank" class="inline-flex items-center justify-center gap-2 px-3 py-2 bg-red-600 text-white text-[12px] font-bold rounded-lg hover:bg-red-700 transition-all">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/admin/participants/show.blade.php ENDPATH**/ ?>