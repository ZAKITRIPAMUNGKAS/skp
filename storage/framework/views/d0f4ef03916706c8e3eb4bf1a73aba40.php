...
<div class="space-y-6">
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <a href="<?php echo e(route('admin.events.presentasi', $event)); ?>" target="_blank"
            ...
            <a href="<?php echo e(route('admin.events.report', $event)); ?>" target="_blank"
            ...
            <a href="<?php echo e(route('admin.events.winnersReport', $event)); ?>" target="_blank"
               class="bg-white rounded-xl border border-gray-100 hover:shadow-md transition-all p-5 group block">
                <div class="flex items-start gap-4">
            ...
            <a href="<?php echo e(route('admin.events.angketReport', $event)); ?>" target="_blank"
               class="bg-white rounded-xl border border-gray-100 hover:shadow-md transition-all p-5 group block">
                <div class="flex items-start gap-4">
            ...
            <a href="<?php echo e(route('admin.events.exportExcel', $event)); ?>"
               class="bg-white rounded-xl border border-gray-100 hover:shadow-md transition-all p-5 group block">
                <div class="flex items-start gap-4">
...
<?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/admin/events/partials/tab-laporan.blade.php ENDPATH**/ ?>