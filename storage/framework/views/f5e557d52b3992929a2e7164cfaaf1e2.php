<?php $__env->startSection('title', 'Login — ARQAM UMS'); ?>
...
<div class="min-h-screen grid grid-cols-1 lg:grid-cols-12 overflow-hidden bg-white">
    ...
    <div class="auth-left lg:col-span-5 flex flex-col justify-between p-8 sm:p-12 xl:p-16 bg-white min-h-screen">
        ...
        <div class="flex items-center justify-between w-full">
            <img src="<?php echo e(asset('logo.webp')); ?>" alt="UMS Logo" class="h-10 object-contain">
            <a href="<?php echo e(route('landing')); ?>" class="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-primary transition-colors">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                ...
                <div class="space-y-1.5" x-data="{ show: false }">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="<?php echo e(route('password.forgot')); ?>" class="text-xs text-primary font-semibold hover:underline">Lupa password?</a>
                    </div>
                    <div class="relative">
        ...
        <div class="w-full text-left text-xs text-gray-400">
            &copy; <?php echo e(date('Y')); ?> Universitas Muhammadiyah Surakarta.
        </div>
    </div>
    ...
    <div class="auth-right hidden lg:col-span-7 bg-gradient-to-br from-[#1A6D9B] to-[#06293F] lg:flex flex-col justify-between p-16 xl:p-24 text-white relative">
        ...
        <div class="max-w-md mx-auto my-auto relative z-10 text-center lg:text-left">
            <div class="w-24 h-24 mb-8 bg-white/10 rounded-3xl p-3 flex items-center justify-center backdrop-blur-md">
                <img src="<?php echo e(asset('logo.webp')); ?>" alt="UMS Logo" class="w-full h-full object-contain filter brightness-0 invert">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\SKRIPSI\SISTEM\resources\views/auth/login.blade.php ENDPATH**/ ?>